    ...
    $(document).ready(function() {
        ...
        var editor = new $.fn.dataTable.Editor( {
            ...
            fields: [{label: "企业名称:", name: "companyname"},
                ...
                {label: "入驻时间:", name: "admissiontime",def:function(){return new Date();},type: "datetime",format:"YYYY-MM-DD HH:mm:ss"},
                {label: "孵化时限:", name: "hatchtime",type: "daterange"},
                {label: "退出时间:", name: "exittime",def:function(){return new Date();},type: "datetime",format:"YYYY-MM-DD HH:mm:ss"},
