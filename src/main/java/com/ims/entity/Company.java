...
public class Company implements Serializable {
    ...
    public void setIsgraduation(int isgraduation) {
    ...
    public float getCurrevenue() {
        return currevenue;
    }

    public void setCurrevenue(float currevenue) {
    ...
    public float getCurtax() {
        return curtax;
    }

    public void setCurtax(float curtax) {
        this.curtax = curtax;
    }

    public float getLasttax() {
        return lasttax;
    }

    public void setLasttax(float lasttax) {
    ...
    public void setHatchtime(String hatchtime) {
