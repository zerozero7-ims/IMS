...
public class JWT {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String token1 = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NDAzNzAzOTM1MjgsInBheWxvYWQiOiJ7XCJ1aWRcIjoyMzQsXCJ1c2VybmFtZVwiOlwiYWJjZFwiLFwicGFzc3dvcmRcIjpcIjEyMzRcIn0ifQ.9PkOkpvIuxCH04uoX68APV2nt3Y2czUDZlMLdqvr4zU";
        ...
        Login l = JWT.unsign(token1, Login.class);
